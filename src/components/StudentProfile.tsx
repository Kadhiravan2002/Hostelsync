...
import { useSingleStudentStatus } from "@/hooks/useStudentLiveStatus";
...
export default function StudentProfile() {
  ...
  const { status: movementStatus } = useSingleStudentStatus(userId);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="text-center space-y-2">
              ...
              <MovementStatusBadge status={movementStatus} />
            </div>
          </div>
